...
EVENT_GEO = {
    ...
    "nym-20260917": ("us", "New York", "纽约", "ニューヨーク"),
    "zuh-20260920": ("cn", "Zhuhai", "珠海", "珠海"),
    "lad-20260922": ("us", "Los Angeles", "洛杉矶", "ロサンゼルス"),
    "sea-20260924": ("us", "Seattle", "西雅图", "シアトル"),
    "sfp-20260929": ("us", "San Francisco", "旧金山", "サンフランシスコ"),
    "chi-20260930": ("us", "Chicago", "芝加哥", "シカゴ"),
    ...
    "sud-20260915": ("ca", "Sudbury", "萨德伯里", "サドベリー"),
    ...
    "raj-20260926": ("in", "Rajkot", "拉杰果德", "ラージコート"),
    ...
    "sha-20261018": ("cn", "Shanghai", "上海", "上海"),
    ...
    "pgh-20261013": ("us", "Pittsburgh", "匹兹堡", "ピッツバーグ"),
    "aus-20260910": ("us", "Austin", "奥斯汀", "オースティン"),
    "aus-20260916": ("us", "Austin", "奥斯汀", "オースティン"),
    "dac-20260925": ("bd", "Dhaka", "达卡", "ダッカ"),
    "dac-20260920": ("bd", "Dhaka", "达卡", "ダッカ"),
    ...
    "yul-20260926": ("ca", "Montreal", "蒙特利尔", "モントリオール"),
    "dub-20261004": ("ie", "Dublin", "都柏林", "ダブリン"),
    "jkt-20261003": ("id", "Jakarta", "雅加达", "ジャカルタ"),
    "mad-20260929": ("es", "Madrid", "马德里", "マドリード"),
    "mia-20260923": ("us", "Miami", "迈阿密", "マイアミ"),
    "atl-20260924": ("us", "Atlanta", "亚特兰大", "アトランタ"),
    "bho-20260926": ("in", "Bhopal", "博帕尔", "ボーパール"),
    "vds-20260927": ("in", "Vidisha", "维迪沙", "ヴィディシャー"),
    "del-20261003": ("in", "Delhi", "德里", "デリー"),
    "jbp-20261004": ("in", "Jabalpur", "贾巴尔普尔", "ジャバルプル"),
    ...
    "yow-20261010": ("ca", "Ottawa", "渥太华", "オタワ"),
    ...
    "ist-20260929": ("tr", "Istanbul", "伊斯坦布尔", "イスタンブール"),
    "bos-20261009": ("us", "Boston", "波士顿", "ボストン"),
    "mty-20261003": ("mx", "Monterrey", "蒙特雷", "モンテレイ"),
    "pdv-20260925": ("it", "Padua", "帕多瓦", "パドヴァ"),
    ...
    "lfw-20260925": ("tg", "Lomé", "洛美", "ロメ"),
    "pei-20261002": ("co", "Pereira", "佩雷拉", "ペレイラ"),
    "ssa-20261008": ("br", "Salvador", "萨尔瓦多", "サルバドール"),
    "alc-20261107": ("es", "Alicante", "阿利坎特", "アリカンテ"),
    ...
    "lax-20260928": ("us", "Los Angeles", "洛杉矶", "ロサンゼルス"),
    "ith-20260929": ("us", "Ithaca", "伊萨卡", "イサカ"),
